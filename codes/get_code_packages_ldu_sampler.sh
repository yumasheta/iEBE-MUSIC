...
# download diluteGlasma
rm -fr diluteGlasma_code
git clone --depth=1 git@gitlab.com:yumasheta/missl_prototype.git -b iEBE-MUSIC diluteGlasma_code
rm -fr diluteGlasma_code/.git

# download MUSIC
rm -fr MUSIC_code
# git clone --depth=1 https://github.com/LipeiDu/MUSIC.git -b du_viscous MUSIC_code
git clone --depth=1 https://github.com/yumasheta/MUSIC.git -b dilute_3D_glasma_init MUSIC_code
rm -fr MUSIC_code/.git

# download iSS particle sampler
rm -fr iSS_code
# git clone --depth=1 https://github.com/chunshen1987/iSS -b momentumSampler iSS_code
git clone --depth=1 https://github.com/chunshen1987/iSS.git -b main iSS_code
rm -fr iSS_code/.git

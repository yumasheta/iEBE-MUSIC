...
music_dict = {
    ...
    'Eta_plateau_size': 4.0,         # [-Eta_plateau_size/2, Eta_plateau_size/2] for entropy density
    'Eta_fall_off': 1.0,            # Gaussian width fall off for entropy density
    ...
    'central_baryon_frac': 0.12,
    'eta_rhob_plateau_size': 1.5,

...
music_dict = {
    ...
    'Eta_plateau_size': 3.2,        # [-Eta_plateau_size/2, Eta_plateau_size/2] for entropy density
    ...
    'rhob_Norm': 1.0,
    'eta_rhob_0': 2.0,              # peak position of the net baryon density
    'eta_rhob_width_1': 0.16,        # Gaussian width for |eta| > |eta_0|
    'eta_rhob_width_2': 1.12,        # Gaussian width for |eta| < |eta_0|

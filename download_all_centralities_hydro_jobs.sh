...
do
    scp lpdu318@beluga.computecanada.ca:/lustre03/project/6002853/lpdu318/iEBE-sampler/$folder/event_0/EVENT_RESULTS_MCGlb${folder}_0/hydro_results_MCGlb${folder}_0.h5 /Users/Lipei/Downloads/sampler_test_runs/Beluga_BES_run2
done

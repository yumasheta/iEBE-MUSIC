...
music_dict = {
    ...
    'ecm': 39.,                    # collision energy
    'Eta_plateau_size': 3.88,        # [-Eta_plateau_size/2, Eta_plateau_size/2] for entropy density
    'Eta_fall_off': 0.35,            # Gaussian width fall off for entropy density
    ...
    'rhob_Norm': 1.1,
    'eta_rhob_0': 2.3,              # peak position of the net baryon density
